<%@ Page Language="C#" MasterPageFile="~/Patient/PatientMasterPage.master" AutoEventWireup="true" CodeFile="frmShowInboxDetails.aspx.cs" Inherits="Admin_frmShowInboxDetails" Title="Untitled Page" %>
                                                    ...
                                                    <td background="../Images/form_tab_bg_off.gif" class="form_tab_off" style="padding-left: 15px">
                                                        <span style="color: #000000">
                                                            <asp:LinkButton ID="LinkButton3" runat="server" Font-Bold="True" ForeColor="#004E69"
                                                                PostBackUrl="~/Patient/frmInboxMails.aspx" 
