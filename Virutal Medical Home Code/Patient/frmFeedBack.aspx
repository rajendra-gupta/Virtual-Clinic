<%@ Page Language="C#" MasterPageFile="~/Patient/PatientMasterPage.master" AutoEventWireup="true" CodeFile="frmFeedBack.aspx.cs" Inherits="Patient_frmFeedBack" Title="Untitled Page" %>
                    ...
                    <table style="border: thin solid #5D7B9D; background-color:window ; width: 500px; ">
                        <tr>
                            <td  colspan="3" style="background-color:#5D7B9D;" >
                                <b style="color: #FFFFFF">FeedBack Form </b>
                            </td>
                            </tr>
                        <tr>
                       ...
                       <tr>
                       <td>FeedBack</td>
                       <td><asp:TextBox ID="txtFeed" TextMode="MultiLine" runat="server" 
                               Height="112px" Width="206px"></asp:TextBox></td>
                       <td>
                    <asp:RequiredFieldValidator ID="rfvFeed" runat="server" ErrorMessage="*" ControlToValidate="txtFeed"></asp:RequiredFieldValidator>
