<%@ Page Language="C#" MasterPageFile="~/Patient/PatientMasterPage.master" AutoEventWireup="true" CodeFile="frmInboxMails.aspx.cs" Inherits="Admin_frmInboxMails" Title="Untitled Page" %>
                                                    ...
                                                    <tr>
                                                        <td background="../Images/form_tab_bg_on.gif" class="form_tab_on" 
                                                            ...
                                                            <asp:LinkButton ID="LinkButton3" runat="server" Font-Bold="True" 
                                                                ...
                                                                PostBackUrl="~/Patient/frmInboxMails.aspx">Inbox</asp:LinkButton>
                                                            </span></a>
                                                        </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td background="../Images/form_tab_bg_off.gif" class="form_tab_off">
                                                                        ...
                                                                        <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" 
                                                                            ...
                                                                            PostBackUrl="~/Patient/frmOutBoxMails.aspx">Outbox</asp:LinkButton>
                                                                        </span></a>
                                                                    </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td background="../Images/form_tab_bg_off.gif" class="form_tab_off">
                                                                                    ...
                                                                                    <asp:LinkButton ID="LinkButton2" runat="server" Font-Bold="True" 
                                                                                        ...
                                                                                        PostBackUrl="~/Patient/frmComposeMail.aspx">Compose</asp:LinkButton>
                                                                                    </a>
                                                                                </td>
                                                                                <td>
