...
public partial class UserControls_BrowsePPTFile : System.Web.UI.UserControl
{
    ...
    {
        Session["PDFFileContent"] = null;
        Session["PDFileName"] = null;
        ...
        try
        {
            if (this.Upload1.PostedFile != null)
            {
                ...
                else
                {
                    ...
                    if (FileData == null)
                    {
                        lblMessage.Text = " PDF Files Only Allowed.";
                    }
                    else
                    {
                        ...
                        if (Session["PDFFileName"] == null)
                            Session.Add("PDFFileName", strFileName);
                        else
                            Session["PDFFileName"] = strFileName;
                        if (Session["PDFFileContent"] == null)
                            Session.Add("PDFFileContent", FileData);
                        else
                            Session["PDFFileContent"] = FileData;
