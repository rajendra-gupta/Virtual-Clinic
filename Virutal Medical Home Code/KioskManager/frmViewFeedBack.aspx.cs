...
public partial class Kiosk_Manager_frmViewFeedBack : System.Web.UI.Page
{
    ...
    protected void btnFeed_Click(object sender, EventArgs e)
    {
        try
        {
            objManager.ReceiverId = Convert.ToInt32(Session["ManagerId"]);
            DataSet ds = objManager.GetFeedBackByReceiverId();
            ViewState["Data"] = ds;
