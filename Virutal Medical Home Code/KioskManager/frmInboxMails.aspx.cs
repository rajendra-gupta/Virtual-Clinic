...
public partial class Admin_frmInboxMails : System.Web.UI.Page
{
    ...
    public void Getdata()
    {
        try
        {
            GridView1.DataSource = Cls_EmailMaster.ShowInboxdetails(Convert.ToInt32(Session["ManagerId"]));
            GridView1.DataBind();
            //  lblMsg.Text = "";
        }
        catch (Exception ex)
    ...
    protected void GridView1_RowCommand1(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EmailId")
        {
            ...
            Response.Redirect("frmShowInboxDetails.aspx?id=" + id);
        }
    }
