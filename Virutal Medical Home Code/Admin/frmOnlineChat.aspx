<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="frmOnlineChat.aspx.cs" Inherits="Admin_frmOnlineChat" Title="Untitled Page" %>
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td align="left" style="text-align: center">
                                        <asp:GridView ID="GvAManagers" ShowHeader="false"  runat="server" Width="150px" BackColor="White" BorderColor="#CCCCCC"
                                ...
                                <tr>
                                <td><b>Doctors available to chat</b></td>
                                </tr>
                                <tr>
                                    <td align="left" style="text-align: center">
                                        <asp:GridView ID="grdDoctor" ShowHeader="false"  runat="server" Width="150px" BackColor="White" BorderColor="#CCCCCC"
                                            BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" 
                                            GridLines="Horizontal">
                                            <FooterStyle BackColor="#CCCC99" ForeColor="Black" />
                                            <PagerStyle BackColor="White" ForeColor="Black" HorizontalAlign="Right" />
